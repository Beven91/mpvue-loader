...
module.exports = function (content) {
  ...
  //设置context用于后续获取compiler.options
  compilerContext.setContext(this, mpOptions);
  //获取compiler的options
  ...
  var options = Object.assign({
    esModule: true
  }, compilerOptions.vue, this.vue, query)
  ...
  const babelLoaderOptions = mpOptions.globalBabelrc ? {
    loader: 'babel-loader',
    options: typeof mpOptions.globalBabelrc === 'string' ? {
      extends: mpOptions.globalBabelrc
    } : mpOptions.globalBabelrc || {}
  } : 'babel-loader'
  ...
  // done
  return [
    'require("mpvue-webpack4-loader/lib/polyfill.js")',
    output,
  ].join('\n');
